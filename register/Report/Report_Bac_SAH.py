...
template_path = os.path.join(os.path.dirname(__file__), "PDF","Bac_SAH_from.pdf")
output_pdf_path = os.path.join(os.path.dirname(__file__), "OUTPUT","SAH_BacReport.pdf")
...
def create_canvas_for_page0():
    ...
    c.drawString(80, 254, note_page1)
    c.drawString(110, 117, name_of_reporter)
    c.drawString(120, 100, position_of_reporter)
    c.drawString(380, 117, name_of_approve_reporter)
    c.drawString(390, 100, position_of_approve_reporter)
    c.save()
    packet.seek(0)
    return packet
