...
template_path = os.path.join(os.path.dirname(__file__), "PDF","Bac_VTK_from.pdf")
output_pdf_path = os.path.join(os.path.dirname(__file__), "OUTPUT","VTK_BacReport.pdf")
...
Interpretation_page1 = "test Interpretation page 1"
# page 2
name_of_reporter = "(นาย ทดสอบ รายงาน)"
position_of_reporter = "นักทดสอบรายงาน"
name_of_approve_reporter1 = "(นาย รับรอง รายงาน คนที่ 1)"
position_of_approve_reporter1 = "นักรับรองรายงาน คนที่ 1"
name_of_approve_reporter2 = "(นาย รับรอง รายงาน คนที่ 2)"
position_of_approve_reporter2 = "นักรับรองรายงาน คนที่ 2"
Interpretation_page2 = "test Interpretation page 2"
...
def create_canvas_for_page0():
    ...
    c.drawString(85, 207, note_page1)
    c.drawString(100, 159, Interpretation_page1)
    c.save()
    packet.seek(0)
    return packet
...
def create_canvas_for_page1():
    ...
    c.setFont("THSarabunNew", 16)
    c.drawString(100, 700, Interpretation_page2)
    c.drawString(65, 123, name_of_reporter)
    c.drawString(75, 107, position_of_reporter)
    c.drawString(230, 123, name_of_approve_reporter1)
    c.drawString(240, 107, position_of_approve_reporter1)
    c.drawString(405, 123, name_of_approve_reporter2)
    c.drawString(415, 107, position_of_approve_reporter2)
    c.save()
    packet.seek(0)
    return packet
