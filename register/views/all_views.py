...
class MainAppView(QMainWindow, Ui_main_app_view):
    ...
    def disable_all_buttons(self):
        ...
        self.addReportPushButton.setEnabled(False)
        self.approveReportPushButton.setEnabled(False)
    ...
    def enable_all_buttons(self):
        ...
        self.addReportPushButton.setEnabled(True)
        self.approveReportPushButton.setEnabled(True)
